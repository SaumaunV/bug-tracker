...
export type User = {
  ...
  id: Scalars['ID'];
  projects?: Maybe<Array<UserProject>>;
};
...
export type GetAllProjectsQuery = { __typename?: 'Query', user_projects?: Array<{ __typename?: 'Project', id: string, name: string, description?: string | null }> | null };
